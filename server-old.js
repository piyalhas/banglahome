...
app.get('/api/properties/:id', async (req, res) => {
    try {
        ...
        if (!property) {
            // fallback demo property if not found in DB
            const demo = {
                '1': {
                    _id: '1',
                    title: "লাক্সারি অ্যাপার্টমেন্ট, গুলশান",
            ...
            const demoProp = demo[req.params.id];
        ...
        const demo = {
            '1': { _id: '1', title: "লাক্সারি অ্যাপার্টমেন্ট, গুলশান", location: "রোড ১২৫, গুলশান", city: "ঢাকা", price: 45000, type: "apartment", bedrooms: 3, bathrooms: 2, size: 1500, images: ["/images/property1.jpg"], owner: { name: "আরিফ আহমেদ", email: "arif@demo.com", phone: "+8801712345678" } },
            '2': { _id: '2', title: "মডার্ন ফ্ল্যাট, বনানী", location: "রোড ১১, বনানী", city: "ঢাকা", price: 35000, type: "apartment", bedrooms: 2, bathrooms: 2, size: 1200, images: ["/images/property2.png"], owner: { name: "সুমাইয়া খান", email: "sumaiya@demo.com", phone: "+8801812345678" } },
            '3': { _id: '3', title: "বাংলো, উত্তরা", location: "সেক্টর ৭, উত্তরা", city: "ঢাকা", price: 60000, type: "house", bedrooms: 4, bathrooms: 3, size: 2000, images: ["/images/property3.png"], owner: { name: "রফিকুল ইসলাম", email: "rafiq@demo.com", phone: "+8801912345678" } },
            '4': { _id: '4', title: "ডুপ্লেক্স, মিরপুর", location: "সেক্টর ১০, মিরপুর", city: "ঢাকা", price: 40000, type: "duplex", bedrooms: 3, bathrooms: 2, size: 1800, images: ["/images/property4.png"], owner: { name: "মো: হাসান", email: "hasan@demo.com", phone: "+8801719888777" } }
        };
        if (demo[id]) return res.json(demo[id]);
        res.status(500).json({ message: 'Server error', error: error.message });
    }
});
